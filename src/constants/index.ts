...
export const PROCEDURE_ZONES = {
  ojos: {
    ...
    options: [
      ...
      { key: "parpado_interior", label: "Párpado interior" },
...
export const MEDICAL_CONDITIONS = [
  ...
  { key: "retinopatia", label: "Retinopatía" },
...
export const CLINICAL_QUESTIONS = [
  ...
  { key: "tatuajes_parpados", label: "Tatuajes en párpados" },
  { key: "perforacion_labios", label: "Perforación en labios" },
  { key: "perforacion_cejas", label: "Perforación en cejas" },
  { key: "micropigmentacion_previa", label: "Micropigmentaciones anteriores" },
  { key: "transfusion", label: "Transfusión sanguínea en los últimos 6 meses" },
  ...
  { key: "coagulacion", label: "Tiene problemas de coagulación" },
  { key: "anticoagulantes", label: "Actualmente toma anticoagulantes" },
  { key: "lunares", label: "Tiene lunares o áreas elevadas cerca del área a tratar" },
  { key: "quimio", label: "Le han practicado quimioterapia / radioterapia" },
  { key: "botox", label: "Aplicación de bótox o rellenos faciales" },
] as const;
...
export const FITZPATRICK_TYPES = [
  {
    type: 1,
    label: "Tipo I",
    description: "Clara, pálida, blanca y muy clara",
  ...
  },
  {
    type: 4,
    label: "Tipo IV",
    description: "De beige a marrón suave / aceitunada",
    reaction: "Rara vez se quema, se broncea fácil a marrón moderado",
    color: "#A67B5B",
  },
  {
    type: 5,
    label: "Tipo V",
    description: "De marrón suave a moderado",
    reaction: "Rara vez se quema, se broncea más que el promedio",
    color: "#6B4226",
  },
  {
    type: 6,
    label: "Tipo VI",
    description: "De marrón muy oscuro a negro",
