    ...
    async (
      ...
      try {
        ...
        const newClient = {
          ...
          fitzpatrickType: input.fitzpatrickType ?? null,
          medicalConditions: input.medicalConditions ?? null,
          clinicalAnswers: input.clinicalAnswers ?? null,
          allergiesDetail: input.allergiesDetail ?? null,
          medicationsDetail: input.medicationsDetail ?? null,
